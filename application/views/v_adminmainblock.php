...
<div id="info">
	...
	<img  src='MEDIA/Images/down5.png'/>
		...
		<div id="topvoting">
	TOP NEWS <?php echo HTML::anchor('indexadmin/addnews', 'ADD');?>
	</div>
</div>
...
<div class="n2">
	...
	<div id="personalinfo">
	<div id="aboutme"><div id="textinside">This is page for Administrators <?php echo $mainblock->name; ?> ONLY!</div></div>
	<div id="myfriends">
...
<div id="info2">
<a href='#'><div id="listennotlisten">ADD VOTINGS</div></a>
